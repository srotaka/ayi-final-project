...
INSERT INTO `ayi_final_project`.`client_details` (`client_detail_id`, `is_vip`,  `points`, `client_id`) SELECT 1, 1,'1000', 1
...
INSERT INTO `ayi_final_project`.`client_details` (`client_detail_id`, `is_vip`,  `points`, `client_id`) SELECT 3, 1, '1000', 3
...
INSERT INTO `ayi_final_project`.`invoices` (`invoice_id`, `description`,  `total_amount`, `client`) SELECT '1', 'TV Smart Samsung','5000', '1'
WHERE NOT EXISTS (SELECT * FROM `invoices` WHERE invoice_id = 1);
INSERT INTO `ayi_final_project`.`invoices` (`invoice_id`, `description`,  `total_amount`, `client`) SELECT '2', 'Heladera Samsung','8000', '2'
WHERE NOT EXISTS (SELECT * FROM `invoices` WHERE invoice_id = 2);
INSERT INTO `ayi_final_project`.`invoices` (`invoice_id`, `description`,  `total_amount`, `client`) SELECT '3', 'Aspiradora Samsung', '3000', '3'
WHERE NOT EXISTS (SELECT * FROM `invoices` WHERE invoice_id = 3);
INSERT INTO `ayi_final_project`.`invoices` (`invoice_id`, `description`,  `total_amount`, `client`) SELECT '4', 'Escritorio','2000', '1'
