...
public class ClientWithAddressRequestDTO{
    ...
    @NotNull
    @ApiModelProperty(notes = "Client's first name is required",  required = true, position = 1)
    private String firstName;

    @NotNull
    @ApiModelProperty(notes = "Client's last name is required", required = true, position = 2)
    ...
    @NotNull
    @ApiModelProperty(notes = "Client's DNI is required", required = true, position = 4)
    private String documentType;

    @Email(regexp = "[\\w-\\.]+@([\\w-]+\\.)+[\\w-]{2,4}", message = "Email format must be valid")
    @ApiModelProperty(notes = "Client's email address is required", position = 5)
    private String email;

    @NotNull
    @ApiModelProperty(notes = "Street name is required", example = "San Martín", required = true, position = 6)
    ...
    @ApiModelProperty(notes = "Street number is required", example = "3364", required = true, position = 7)
    ...
    @ApiModelProperty(notes = "Address floor", example = "11",required = true, position = 8)
    private Integer floor;

    @ApiModelProperty(notes = "Address apartment unit", example = "B",position = 9)
